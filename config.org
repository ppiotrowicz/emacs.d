...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key pp/global-map (kbd "'") 'terminal-focus)
...
#+END_SRC
* Todo
- better ruby toggle symbol function
- bindings for prev/next changes (hydra?)
- SPC keymaps in dired mode
- SPC keymaps in magit mode
- customize org faces
  - green checkbox for completed task
  - strikethrough completed tasks
- checkout evil embrace and/or shackle
- easy next/prev command with shell and irb
- https://github.com/alf/ob-restclient.el
- https://github.com/pidu/git-timemachine
- https://m.reddit.com/r/emacs/comments/51jvai/making_modern_emacs_themes
